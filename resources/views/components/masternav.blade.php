        ...
        <div class="lg:flex flex-grow items-center bg-gray-300 rounded-lg lg:bg-transparent lg:shadow-none hidden"
            ...
            <ul class="flex flex-col lg:flex-row list-none mr-auto">
                <li class="flex items-center">
                    ...
                    <a class="{{ request()->is('checking-and-savings') ? 'border-b-4 border-gray-700 pb-4 ' : '' }}  text-black  lg:hover:text-gray-300  px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                        href="{{ route('cands') }}">
                        Checking & Savings
                    </a>
                </li>
                <li class="flex items-center">
                    ...
                    <a class="{{ request()->is('credit-cards') ? 'border-b-4 border-gray-700 pb-4 ' : '' }} text-black  lg:hover:text-gray-300  px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                        href="{{ route('cc') }}">
                        Credit Cards</a>
                </li>
                <li class="flex items-center">
                    ...
                    <a class="{{ request()->is('loans') ? 'border-b-4 border-gray-700 pb-4 ' : '' }} text-black  lg:hover:text-gray-300  px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                        href="{{ route('loans') }}">
                        Loans</a>
                </li>
                <li class="flex items-center">
