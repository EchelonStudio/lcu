    ...
    <div
        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden"
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none ">
                ...
                <li class="items-center mt-4">
                    <div>
                        ...
                        <a href="{{ route('transfer') }}"
                            class="{{ request()->is('user/account/transfer') ? 'text-pink-500' : '' }} uppercase text-blueGray-700  text-xs py-3 font-bold">Transfer
                        </a>
                ...
                <li class="items-center mt-4">
                    <a class="{{ request()->is('user/account/deposit') ? 'text-pink-500' : '' }} text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                ...
                <li class="items-center flex mt-4">
